...
[SEGMENT .data]
	strWelcomeMsg		db	"Welcome to KAV_OS version 1.0.0", 0x00

	wel1 db	'*************************************************', 0x00			

	wel2 db '*********** WELCOME TO KAV_OS ************', 0x00 
	...
	wel7 db ' version 1.0.0 of KAV_OS From A.M.N.K.Abeykoon - SE/2019/021', 0x00
	...
	strPrompt		db	"KAV_OS>>", 0x00
	cmdMaxLen		db	255			;maximum length of commands

	strOsName		db	"KAV", 0x00	;OS details
